...
- One disruption → one recovery story → six focused scenes → one compact industry collaboration section
...
- Scheduler confirms the LLM interpretation before the scheduling engine recomputes
